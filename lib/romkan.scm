...
;;--------------------------------------------------
;; くんれい->かな 変換
(define (romkan-kunrei->kana str)
  (romkan-convert
   (romkan-alist->alist romkan-kunrei-alist 'normal)
   str))

;; かな->くんれい 変換
;;   (カタカナ文字列もローマ字変換の対象となる)
(define (romkan-kana->kunrei str)
  (romkan-convert
   (romkan-alist->alist romkan-kunrei-alist 'reverse)
