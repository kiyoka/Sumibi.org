	   ...
	   (html:body
	    ...
	    (html:div :style "text-align: center; "
		      (html:form :id "gform" :method "get" :action "./index.cgi" :target "_top"
				 ...
				 (if long-mode
				     (html:div :style "text-align: center; "
					       (html:textarea :id "qbox" :name "q" :cols "90%" :rows "12" :onKeyPress "Sumibi_key_process_in_text( event )")
					       )
				     (html:div
				      (html:p
				       (html:input :type "text" :id "qbox" :name "q" :size "41" :maxlength "2048" :onKeyPress "Sumibi_key_process_in_text( event )" :value
                                                   (if qbox-value
                                                       qbox-value
                                                       ""))
	    ...
	    (html:fieldset :class "fieldset"
	     ...
	     (html:ul
		  ...
		  (html:li "助詞『は』『を』『と』『に』等 はスペースで区切って入力します。(例: watashi ha ryokou ga sukidesu.  →  私は旅行が好きです。)")
                  (html:li "スペースは、スペースを二回入力して下さい。 (例: kaigai&nbsp;&nbsp;&nbsp;tensyoku →  海外&nbsp;転職)"))
